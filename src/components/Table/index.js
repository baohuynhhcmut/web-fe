              ...
              {DataRender.map((dataRow, index) => {
                ...
                return (
                  <tr key={index} className="hover:bg-gray-50">
                    {row.map((value, i) => (
                      <td key={i} className="w-[20px] h-[40px] text-ellipsis overflow-hidden px-4 py-6 border-b text-gray-800">
                         <p class="w-[65px] h-[160px] text-clip ">{value}</p>
                      </td>
                    ))}
                    {/* <td className="px-4 py-6 border-b text-gray-800">
                      {dataRow?.name}
                    </td>
                    <td className="px-4 py-6 border-b text-gray-800">
                      {dataRow?.publisher}
